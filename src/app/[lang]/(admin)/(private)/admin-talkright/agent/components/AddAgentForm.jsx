...
const accountSchema = object({
  ...
  user: pipe(string(), nonEmpty('This field is required'), minLength(1)),
...
const AddAgentForm = () => {
  ...
  const handleReset = () => {
    setActiveStep(0)
    accountReset({ name: '', phone: '', language: '', voice: '', user: '', message: '' })
          ...
          <form key={0} onSubmit={(handleAccountSubmit(onSubmit))}>
            <Grid container spacing={6}>
              ...
              <Grid item xs={12} sm={12}>
                <Controller
                  ...
                  render={({ field }) => (
                    <CustomTextField
                      ...
                      label='User'
                      {...field}
                      error={Boolean(accountControl.user)}
                    >
                ...
                />
                {accountErrors.user && <FormHelperText error>user is a required field</FormHelperText>}
              </Grid>
              <Grid item xs={12}>
                <Controller
                  name='message'
