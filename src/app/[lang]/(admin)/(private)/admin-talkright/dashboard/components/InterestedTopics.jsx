...
const data1 = [
  { title: 'Hospital 1', value: 35, colorClass: 'text-primary' },
  { title: 'Hospital 2', value: 20, colorClass: 'text-info' },
  { title: 'Hospital 3', value: 18, colorClass: 'text-secondary' }
]

const data2 = [
  { title: 'Hospital 4', value: 16, colorClass: 'text-success' },
  { title: 'Hospital 5', value: 10, colorClass: 'text-warning' },
  { title: 'Hospital 6', value: 9, colorClass: 'text-error' }
]

const labels = ['Hospital 1', 'Hospital 2', 'Hospital 3', 'Hospital 4', 'Hospital 5', 'Hospital 6']
...
const InterestedTopics = () => {
  ...
  return (
    <Card>
      <CardHeader
        title='Total Organizational Appointments'
      />
      <CardContent>
        <Grid container>
